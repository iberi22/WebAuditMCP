...
**Location:** E:\scripts-python\webscanMCP
...
- Run `python -m flake8 .` before committing
...
- `pyproject.toml or requirements.txt` - Configuration documentation
